...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Edit Data</h4>
...
while (rs.next()) {
%>
            <form method="POST" action="config/update.jsp">
                <div class="form-group">
                    <input type="hidden" name="id" value="<%=request.getParameter("id")%>">
                    <label>Nama Anda</label>
                    <input class="form-control" type="text" name="name" size="50" value="<%=rs.getString("name")%>" size="50"/>
                </div>
                <div class="form-group">
                    <label>Kota</label>
                    <input class="form-control" type="text" name="city" size="50"  value="<%=rs.getString("city")%>"/>
                </div>
                <div class="form-group">
                    <label>Hobi</label>
                    <input class="form-control" type="text" name="hobi" size="50"  value="<%=rs.getString("hobi")%>"/>
                </div>
                <div class="form-group">
                    <label>Nomor Telepon</label>
                    <input class="form-control" type="number" name="phone" size="50" value="<%=rs.getString("phone")%>" />
                </div>
                <div class="form-group">
                    <label>Alasan</label>
                    <textArea class="form-control" name="alasan"><%=rs.getString("alasan")%></textarea>
                </div>
